...
/// </summary>
public record CreateEntityCommand<T>(T Entity) : Idevs.Foundation.Cqrs.Commands.ICommand<T>;

/// <summary>
/// Command to create multiple entities.
/// </summary>
public record CreateEntitiesCommand<T>(IEnumerable<T> Entities) : Idevs.Foundation.Cqrs.Commands.ICommand<List<T>>;

/// <summary>
/// Command to update an entity.
/// </summary>
public record UpdateEntityCommand<T>(T Entity) : Idevs.Foundation.Cqrs.Commands.ICommand<T>;

/// <summary>
/// Command to update multiple entities.
/// </summary>
public record UpdateEntitiesCommand<T>(IEnumerable<T> Entities) : Idevs.Foundation.Cqrs.Commands.ICommand<List<T>>;

/// <summary>
/// Command to delete an entity by ID.
/// </summary>
public record DeleteEntityCommand<T, TId>(TId Id) : Idevs.Foundation.Cqrs.Commands.ICommand<int>;

/// <summary>
/// Command to delete multiple entities by IDs.
/// </summary>
public record DeleteEntitiesCommand<T, TId>(IEnumerable<TId> Ids) : Idevs.Foundation.Cqrs.Commands.ICommand<int>;
...
/// </summary>
public record GetByIdQuery<T, TId>(TId Id) : Idevs.Foundation.Cqrs.Queries.IQuery<T?>;

/// <summary>
/// Query to get entities by IDs.
/// </summary>
public record GetByIdsQuery<T, TId>(IEnumerable<TId> Ids) : Idevs.Foundation.Cqrs.Queries.IQuery<List<T>>;

/// <summary>
/// Query to get all entities.
/// </summary>
public record GetAllQuery<T> : Idevs.Foundation.Cqrs.Queries.IQuery<List<T>>;

/// <summary>
/// Query to get entities by predicate.
/// </summary>
public record GetByPredicateQuery<T>(Expression<Func<T, bool>> Predicate) : Idevs.Foundation.Cqrs.Queries.IQuery<List<T>>;

/// <summary>
/// Query to check if an entity exists.
/// </summary>
public record EntityExistsQuery<T, TId>(TId Id) : Idevs.Foundation.Cqrs.Queries.IQuery<bool>;
