...
using Autofac;
using Idevs.Foundation.Autofac.Modules;
using Idevs.Foundation.Serilog.Extensions;
using Microsoft.Extensions.Configuration;
using Serilog;

namespace Idevs.Foundation.Autofac.Extensions;
...
{
    /// <summary>
    /// Registers Idevs Foundation components with CQRS and mediator support.
    /// </summary>
    ...
    /// <summary>
    /// Registers Idevs Foundation components with CQRS and mediator support for the calling assembly.
    /// </summary>
    /// <param name="builder">The container builder.</param>
    /// <param name="registerLoggingBehavior">Whether to register the logging behavior.</param>
    /// <returns>The container builder for chaining.</returns>
